...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{optimalMinor <-}\StringTok{ }\NormalTok{optimalMultipleMinor}\OperatorTok{$}\NormalTok{U[[}\DecValTok{1}\NormalTok{]]}
\NormalTok{optimalVSTruePerpetratorProfile <-}\StringTok{ }
\StringTok{    }\KeywordTok{ggplotComparingProfiles}\NormalTok{(sampleTibble, knownProfilesIndividual, }
\NormalTok{                            optimalMinor, }\OtherTok{TRUE}\NormalTok{, }\KeywordTok{c}\NormalTok{(}\StringTok{"True"}\NormalTok{, }\StringTok{"Optimal"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
