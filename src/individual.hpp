...
class Individual
{
    public:
        ...
        void CreateReducedElements(const ExperimentalSetup & ES, const Eigen::MatrixXd & decodedProfile);
        ...
        void CalculateFitness(const ExperimentalSetup & ES, const Eigen::MatrixXd & decodedProfile);
